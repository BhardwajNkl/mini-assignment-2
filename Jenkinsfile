    ...
    stages {        
        ...
        stage('Deploy'){
          steps{
            ...
            sh "docker run --name mini_2_app --link mysql:mysql -e SPRING_DATASOURCE_URL=jdbc:mysql://mysql:3306/mini2_2 -p 4000:4000 mini_2_app"
